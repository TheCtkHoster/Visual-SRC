local version = '1'
print(version)
warn('leaked by asynclol. [discord]')
warn('script by envert [discord]')
...
local nurysium_Util = loadstring(game:HttpGet('https://raw.githubusercontent.com/TheCtkHoster/Visual-SRC/main/nurysium_helper.lua'))()
...
local Window = Fluent:CreateWindow({
    Title = "Visual [NURYSIUM RESKIN]" .. version,
    SubTitle = "Edited",
    TabWidth = 160,
...
Fluent:Notify({
    Title = "Visual V3 [NURYSIUM RESKIN]",
